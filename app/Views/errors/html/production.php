...
<head>
    ...
    <title><?= lang('Errors.whoops') ?> | FamilyJam</title>
...
<div class="shell shell--auth">
    ...
    <main class="auth-main">
        <section class="panel panel--hero">
            <div class="stack">
                <p class="eyebrow"><?= esc(ui_locale() === 'it' ? 'Errore applicazione' : 'Application error') ?></p>
                <h1><?= lang('Errors.whoops') ?></h1>
                <p class="hero__lead"><?= lang('Errors.weHitASnag') ?></p>
    ...
    <footer class="footer">
        <p><?= esc(ui_locale() === 'it' ? 'FamilyJam gestisce layout, contesto tenant e filtri base dell’applicazione.' : 'FamilyJam handles layout, tenant context and base application filters.') ?></p>
    </footer>
</div>
