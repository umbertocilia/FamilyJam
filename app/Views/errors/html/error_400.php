...
<head>
    ...
    <title><?= lang('Errors.badRequest') ?> | FamilyJam</title>
...
<div class="shell shell--auth">
    ...
    <footer class="footer">
        <p><?= esc(ui_locale() === 'it' ? 'FamilyJam su CodeIgniter 4 con tema chiaro/scuro e interfaccia responsive.' : 'FamilyJam on CodeIgniter 4 with light/dark theme and responsive UI.') ?></p>
    </footer>
</div>
